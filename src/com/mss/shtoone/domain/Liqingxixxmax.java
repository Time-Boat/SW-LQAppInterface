...
@Entity
public class Liqingxixxmax implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -4377979904845032169L;


	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private int realbianhao;
	...
	public int getRealbianhao() {
		return realbianhao;
	}

	public void setRealbianhao(int realbianhao) {
