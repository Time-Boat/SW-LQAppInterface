...
@Entity
public class HntbhzziduancfgView implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3249141518295060042L;
	@Id
	...
	public Integer getBhzid() {
		return bhzid;
	}
	public void setBhzid(Integer bhzid) {
		this.bhzid = bhzid;
	}
