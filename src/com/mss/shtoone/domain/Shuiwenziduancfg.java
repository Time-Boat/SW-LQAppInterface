...
@Entity
public class Shuiwenziduancfg implements Serializable{
	/**
	 * 
	 */
	...
	private String chaobiaojisuanfangshi;
	
    private String lilunpeibi;
    
    
	public String getLilunpeibi() {
		return lilunpeibi;
	}

	public void setLilunpeibi(String lilunpeibi) {
		this.lilunpeibi = lilunpeibi;
	}

	public String getChaobiaojisuanfangshi() {
		return chaobiaojisuanfangshi;
	}

	public void setChaobiaojisuanfangshi(String chaobiaojisuanfangshi) {
		this.chaobiaojisuanfangshi = chaobiaojisuanfangshi;
	}
