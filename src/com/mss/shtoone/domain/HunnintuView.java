...
@Entity
public class HunnintuView implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -2968708748437769718L;
	...
	private String sha1chazhi;
	private String shi1chazhi;
	private String shi2chazhi;
	private String sha2chazhi;
	private String guliao5chazhi;
	private String shui1chazhi;
	private String shui2chazhi;
	private String shuini1chazhi;
	private String shuini2chazhi;
	private String kuangfen3chazhi;
	private String feimeihui4chazhi;
	private String fenliao5chazhi;
	private String fenliao6chazhi;
	private String waijiaji1chazhi;
	private String waijiaji2chazhi;
	private String waijiaji3chazhi;
	private String waijiaji4chazhi;
	private String xa;
	private String xb;
	...
	public String getSha1chazhi() {
		return sha1chazhi;
	}

	public void setSha1chazhi(String sha1Chazhi) {
		sha1chazhi = sha1Chazhi;
	}

	public String getShi1chazhi() {
		return shi1chazhi;
	}

	public void setShi1chazhi(String shi1chazhi) {
		this.shi1chazhi = shi1chazhi;
	}

	public String getShi2chazhi() {
		return shi2chazhi;
	}

	public void setShi2chazhi(String shi2chazhi) {
		this.shi2chazhi = shi2chazhi;
	}

	public String getSha2chazhi() {
		return sha2chazhi;
	}

	public void setSha2chazhi(String sha2chazhi) {
		this.sha2chazhi = sha2chazhi;
	}

	public String getGuliao5chazhi() {
		return guliao5chazhi;
	}

	public void setGuliao5chazhi(String guliao5chazhi) {
		this.guliao5chazhi = guliao5chazhi;
	}

	public String getShui1chazhi() {
		return shui1chazhi;
	}

	public void setShui1chazhi(String shui1chazhi) {
		this.shui1chazhi = shui1chazhi;
	}

	public String getShui2chazhi() {
		return shui2chazhi;
	}

	public void setShui2chazhi(String shui2chazhi) {
		this.shui2chazhi = shui2chazhi;
	}

	public String getShuini1chazhi() {
		return shuini1chazhi;
	}

	public void setShuini1chazhi(String shuini1chazhi) {
		this.shuini1chazhi = shuini1chazhi;
	}

	public String getShuini2chazhi() {
		return shuini2chazhi;
	}

	public void setShuini2chazhi(String shuini2chazhi) {
		this.shuini2chazhi = shuini2chazhi;
	}

	public String getKuangfen3chazhi() {
		return kuangfen3chazhi;
	}

	public void setKuangfen3chazhi(String kuangfen3chazhi) {
		this.kuangfen3chazhi = kuangfen3chazhi;
	}

	public String getFeimeihui4chazhi() {
		return feimeihui4chazhi;
	}

	public void setFeimeihui4chazhi(String feimeihui4chazhi) {
		this.feimeihui4chazhi = feimeihui4chazhi;
	}

	public String getFenliao5chazhi() {
		return fenliao5chazhi;
	}

	public void setFenliao5chazhi(String fenliao5chazhi) {
		this.fenliao5chazhi = fenliao5chazhi;
	}

	public String getFenliao6chazhi() {
		return fenliao6chazhi;
	}

	public void setFenliao6chazhi(String fenliao6chazhi) {
		this.fenliao6chazhi = fenliao6chazhi;
	}

	public String getWaijiaji1chazhi() {
		return waijiaji1chazhi;
	}

	public void setWaijiaji1chazhi(String waijiaji1chazhi) {
		this.waijiaji1chazhi = waijiaji1chazhi;
	}

	public String getWaijiaji2chazhi() {
		return waijiaji2chazhi;
	}

	public void setWaijiaji2chazhi(String waijiaji2chazhi) {
		this.waijiaji2chazhi = waijiaji2chazhi;
	}

	public String getWaijiaji3chazhi() {
		return waijiaji3chazhi;
	}

	public void setWaijiaji3chazhi(String waijiaji3chazhi) {
		this.waijiaji3chazhi = waijiaji3chazhi;
	}

	public String getWaijiaji4chazhi() {
		return waijiaji4chazhi;
	}

	public void setWaijiaji4chazhi(String waijiaji4chazhi) {
		this.waijiaji4chazhi = waijiaji4chazhi;
	}
