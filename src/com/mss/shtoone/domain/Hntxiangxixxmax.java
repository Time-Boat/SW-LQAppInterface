...
@Entity
public class Hntxiangxixxmax implements Serializable {


	/**
	 * 
	 */
	private static final long serialVersionUID = 1275454601280440662L;
	...
	public Integer getRealbianhao() {
		return realbianhao;
	}

	public void setRealbianhao(Integer realbianhao) {
		this.realbianhao = realbianhao;
	}
